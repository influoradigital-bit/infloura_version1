...
import com.influora.web.dto.admin.AdminSupportDtos.EscalateRequest;
...
public class AdminSupportController {
    ...
    public TicketDetailDto escalate(
            ...
            HttpServletRequest request,
            @PathVariable String id,
            @Valid @RequestBody EscalateRequest body) {
        return adminSupportService.escalate(principal, request, id, body.reason());
    }
}
