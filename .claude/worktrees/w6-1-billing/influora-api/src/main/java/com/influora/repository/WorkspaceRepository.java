...
public interface WorkspaceRepository
    ...
    /**
     * M-28 — exact count counterpart to {@link
     * #findByTypeAndVerificationStatusOrderByCreatedAtAsc}'s bounded-page list, for {@code
     * AdminDashboardService.operations}'s {@code reviewBacklog} KPI (which needs a true total, not
     * a page capped at {@code ApprovalWorkflowService.QUEUE_PAGE_SIZE}).
     */
    long countByTypeAndVerificationStatus(WorkspaceType type, VerificationStatus verificationStatus);
