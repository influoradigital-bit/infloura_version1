...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Per-(workspace,metric,period) distinct-entity dedup rows backing per-creator-lookup counting for usage_counters -- Task 22 Flag #1 fix';
