...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Subscription pricing tiers — defines limits + feature gates + fee overrides';

-- Subscription: 1:1 with workspaces (a workspace can have at most one active subscription)
CREATE TABLE subscriptions (
  id CHAR(26) PRIMARY KEY,
  workspace_id CHAR(26) NOT NULL UNIQUE COMMENT '1:1 with workspaces — a workspace has at most one subscription',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Workspace subscriptions — 1:1 with workspaces';

-- Invoice: billing history + PDF archive
CREATE TABLE invoices (
  id CHAR(26) PRIMARY KEY,
  subscription_id CHAR(26) NOT NULL,
  workspace_id CHAR(26) NOT NULL COMMENT 'Denormalized for fast workspace-scoped queries',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Subscription invoices + PDF archive';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Per-workspace usage counters for plan limits';
