...
public class ConversionTrackingService {
    ...
    /** [SEC: Vikram, P1] Namespace for the reservation key guarding {@link #doRecordConversion}. */
    ...
    public void recordConversion(
        ...
        try {
            idempotencyService.executeOnce(
                    ...
                    IDEMPOTENCY_SCOPE,
                    () -> {
                        doRecordConversion(utmCampaignId, orderId, orderAmount, idempotencyKey);
                        return null;
                    });
    ...
    @Transactional
    protected void doRecordConversion(
            String utmCampaignId, String orderId, BigDecimal orderAmount, String idempotencyKey) {
        UtmCampaign utm =
