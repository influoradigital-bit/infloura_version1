      ...
      <Dialog open={showSignDialog} onOpenChange={setShowSignDialog}>
        <DialogContent className="sm:max-w-lg">
          ...
          <DialogFooter>
            ...
            <Button disabled={!signatureText} onClick={() => setShowSignDialog(false)}>
              <Pen className="w-4 h-4 mr-2" />
              Sign Contract
            </Button>
          </DialogFooter>
      ...
      <Dialog open={showReviewDialog} onOpenChange={setShowReviewDialog}>
        <DialogContent className="sm:max-w-lg">
          ...
          <DialogFooter className="flex-col sm:flex-row gap-2">
            ...
            <Button variant="outline" onClick={handleRequestRevision} className="w-full sm:w-auto gap-1">
              <RotateCcw className="w-4 h-4" />
              Request Revision
            </Button>
            <Button onClick={handleApproveDeliverable} className="w-full sm:w-auto gap-1 bg-stage-approved-fg hover:opacity-90 text-white">
