...
/**
 * D14 Doc#2 (creator service invoice, Creator -> Brand). Created inside the SAME transaction as
 * the escrow-release ledger posting that pays the creator — wired into all three {@code
