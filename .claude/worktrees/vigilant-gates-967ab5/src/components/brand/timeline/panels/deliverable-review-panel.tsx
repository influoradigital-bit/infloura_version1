...
/**
 * Emitted up the timeline when a brand approves or requests a revision on a
 * deliverable, so the timeline can optimistically override that deliverable's
 * status. `deliverableId` is the deliverable this event maps to (event
 * metadata's `deliverableId`), `status` is the new deliverable status, and
 * `feedback` is the optional note the brand left.
 */
