    ...
    public ResponseEntity<ApiResponse<SendTurnResponse>> sendTurn(
        ...
        var result =
                sessionService.sendTurn(
                        workspaceId, principal.getUserId(), conversationId, body.content());
        var credit = creditService.getStatus(workspaceId);
        ...
        var response =
                new SendTurnResponse(
                        ...
                        result.streamToken(),
                        // Placeholder stream URL — the real Domain D edge is not wired in this phase.
                        "https://ai.influora.internal/stream",
