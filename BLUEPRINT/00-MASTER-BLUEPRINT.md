...
| 06 | `06-DEPLOYMENT-AND-API-KEYS.md` | Every API key/secret: which file it goes in, and how | Priya / Meera (DevOps) |
...
| 10 | `10-RUN-ON-SERVER-UTHO.md` | Step-by-step Utho deploy, all three languages | Priya / Meera (DevOps) |
