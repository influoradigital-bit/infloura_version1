...
`[TDS RATE — pending CA confirmation]`

We are not publishing a specific percentage here until our Chartered Accountant confirms the rate currently in force under Section 194-O. Tax rates and thresholds are set by the Finance Act and can change — we will not guess or publish an unconfirmed number in a live tax policy.

## 4. PAN matters — it changes your rate
...
**Always complete your KYC with a valid PAN** — see our KYC Policy — to avoid the higher no-PAN deduction rate.

## 5. TDS is separate from GST on our Platform fee
...
Tax rates and thresholds are set by Indian law and can change. We'll update this policy and the "Last updated" date whenever our CA confirms a rate change, and we'll never publish a number here that hasn't been CA-confirmed.

## 9. Questions

For TDS or certificate questions, contact `info@influora.in`. For personal tax advice, please consult your own CA — we can't provide that.
