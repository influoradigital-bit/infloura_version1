...
If a brand and creator disagree about a Campaign, this is how we investigate and resolve it — including how protected funds get released or returned.
...
1. **Open the dispute** — either party raises it through the platform, with supporting evidence (brief, messages, Deliverable, screenshots).
2. **Payment protection freeze** — the Campaign's protected funds are frozen the moment a dispute opens. No release happens until the dispute is resolved.
3. **Response window** — the other party gets a set window to respond with their own evidence.
4. **Review** — our team reviews both sides against the agreed Campaign brief and platform records.
5. **Outcome and release** — payment protection is released according to the outcome (see below).
