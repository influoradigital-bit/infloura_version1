...
import { HumanStepHandoff, type HumanStepKey } from '@/components/feature/meera/HumanStepHandoff'
...
// Human-step hand-off (P1-7) — EV-024: the card itself now lives in
// ./HumanStepHandoff.tsx so the Living Canvas's funding stage renders the same
// one instead of its own placeholder-campaign pay button. Copy and destination
// are defined there.
