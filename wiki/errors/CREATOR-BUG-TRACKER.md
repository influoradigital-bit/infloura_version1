...
**By status:** 1 `IN QA` · 42 `IN VERIFY` · 1 `IN PROGRESS` · **3 `ASSIGNED`** · 3 `BLOCKED` · **0 `OPEN`** · **0 `DONE`**
...
**The ~~6~~ ~~5~~ ~~4~~ ~~5~~ 6 not yet fully landed, and why — none of them is "not got to it yet":** *(CR-37 has left this table — its fix landed in `7991342`, second deploy pass; see the note under the table. CR-36 has now left it too — `c328b42`, 8th pass. **CR-48 ENTERED it 2026-07-29 — see the row below and the correction note.**)*
...
**Owner:** **Vikram** · **Status:** ASSIGNED *(routed 2026-07-29 by the repo owner; `ASSIGNED` records routing, not Vikram's acceptance — see the §3 routing box)* · *(surfaced by Kavya's QA of `7ea0756`, 2026-07-29; non-blocking)*
...
**Owner:** **Vikram** · **Status:** ASSIGNED *(routed 2026-07-29 by the repo owner; records routing, not acceptance — see the §3 routing box)*
