...
**By status:** 4 `IN QA` · 39 `IN VERIFY` · 1 `IN PROGRESS` · 1 `ASSIGNED` · 3 `BLOCKED` · **0 `OPEN`** · **0 `DONE`**
...
**Owner:** Unrouted → **Vikram** (backend) · **Status:** IN QA · *(surfaced by Kabir's CR-36 red-team, 2026-07-29; non-blocking)*
