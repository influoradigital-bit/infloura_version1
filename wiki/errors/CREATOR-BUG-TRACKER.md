...
**The ~~6~~ ~~5~~ ~~4~~ 5 not yet fully landed, and why — none of them is "not got to it yet":** *(CR-37 has left this table — its fix landed in `7991342`, second deploy pass; see the note under the table. CR-36 has now left it too — `c328b42`, 8th pass. **CR-48 ENTERED it 2026-07-29 — see the row below and the correction note.**)*
