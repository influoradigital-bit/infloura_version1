...
**Totals:** 8 Critical · 8 High · 15 Medium · 9 Low = **40 logged**, **0 DONE**
...
**By status:** 23 `IN QA` · 11 `IN VERIFY` · 2 `IN PROGRESS` · 1 `ASSIGNED` · 3 `BLOCKED` · **0 `OPEN`** · **0 `DONE`**
