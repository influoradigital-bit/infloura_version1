...
| CR-37 | 🟡 Medium | Privilege inversion: a workspace `VIEWER` can cancel a contracted, funded deal, while funding/release/refund require `OWNER`/`ADMIN`. ~~**⛔ Kavya HOLD 2026-07-29** — `7991342` left `createProposal` ungated~~ **→ HOLD LIFTED: the fourth door is closed in `19d4085`. Awaiting an INDEPENDENT QA pass (fix written by the same agent that found it). See §5.** | Vikram | IN QA |
...
**Totals:** 8 Critical · 11 High · 19 Medium · 12 Low = **50 logged**, **0 DONE**
...
**By status:** **3 `IN QA`** · 42 `IN VERIFY` · 1 `IN PROGRESS` · **1 `ASSIGNED`** · 3 `BLOCKED` · **0 `OPEN`** · **0 `DONE`**
...
**The ~~6~~ ~~5~~ ~~4~~ ~~5~~ ~~6~~ 4 not yet fully landed, and why — none of them is "not got to it yet":** *(CR-37 has left this table — its fix landed in `7991342`, second deploy pass; see the note under the table. CR-36 has now left it too — `c328b42`, 8th pass. **CR-48 ENTERED it 2026-07-29 — see the row below and the correction note.**)*
...
**Owner:** Vikram · **Status:** IN QA — ~~⛔ **Kavya HOLD**~~ **HOLD LIFTED (`19d4085`); awaiting independent QA**
