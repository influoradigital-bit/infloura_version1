...
**By status:** 3 `IN QA` · 38 `IN VERIFY` · 2 `IN PROGRESS` · 1 `ASSIGNED` · 3 `BLOCKED` · **0 `OPEN`** · **0 `DONE`**
...
**The ~~6~~ 5 not yet fully landed, and why — none of them is "not got to it yet":** *(CR-37 has left this table — its fix landed in `7991342`, second deploy pass; see the note under the table.)*
