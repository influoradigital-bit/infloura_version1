...
At ₹1,50,000/month of published campaign budget, Pro (₹10,500 fee + ₹4,999 price = ₹15,499) costs slightly *more* than Free (₹15,000) — intentional; Pro isn't meant to win on fee math alone at that size. **Breakeven ≈ ₹1,66,600/month.** Derivation, from this section's own rates: Free pays `0.10x`, Pro pays `0.07x + 4999`, so the two meet at `x = 4999 / 0.03 = ₹1,66,633`. GST does not move it — charged on both legs it cancels. The fee base is the campaign's committed budget (`budgetMax`) at publish, not realised spend; see `BrandCampaignFeeService.chargeOnPublish`. (Corrected 2026-09-07: this line previously read ₹2,10,000, which is ~₹1,300/month *past* breakeven and did not follow from the rates above. The wrong figure had reached the live pricing page.) Above that, the 3-point fee cut outweighs the subscription price — squarely inside the "growth tier" brand range (₹4–10L/month, per market data). Below breakeven, the analytics/export/seat/AI limits are the reason to upgrade, not the fee.
